...
<%@ Register Tagprefix="WebPartPages" Namespace="Microsoft.SharePoint.WebPartPages"
 ...
 <link rel="stylesheet" href="/_layouts/15/1036/styles/Themable/corev15.css">
    ...
    <SharePoint:ScriptLink name="SP.js" runat="server" OnDemand="true" LoadAfterUI="true"
        Localizable="false" />
    <SharePoint:ScriptLink name="SP.UserProfiles.js" runat="server" ondemand="false"
...
<script type="text/javascript" src="/_layouts/15/SP.UserProfiles.js.js"></script>-->
  ...
  <body>
   ...
   <!-- TOP MENU -->
            <img id="btn" data-bs-toggle="offcanvas" data-bs-target="#ffcSideMenu"
              aria-controls="ffcSideMenu" src="/tools1/assets/img/logo-sans-fond.png" alt="logo-sans-fond" width="100"
              height="" />
  ...
  <!-- FORM CANVAS -->
          <div class="offcanvas offcanvas-50 offcanvas-end" tafandex="-1" id="ffcMainForm" data-bs-backdrop="true"
            aria-labelledby="ffcMainFormTitle">
  ...
  <!-- SIDE MENU CANVAS -->
          <div class="offcanvas offcanvas-start text-dark" data-bs-scroll="true"  data-bs-backdrop="true" tafandex="-1"
            id="ffcSideMenu" aria-labelledby="ffcSideMenuLabel">
            <div class="offcanvas-header">
  ...
  <!-- USER MENU -->
          <div class="dropdown d-flex align-self-lg-end text-end p-2">
            ...
            <a href="#" class="d-block link-dark text-decoration-none text-light dropdown-toggle" id="cmdShowUserMenu"
