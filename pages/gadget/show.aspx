  ...
  <table>
    ...
    <tr>
      ...
      <td style="text-align:left;"> {{superieur}}  </td>
                  ...
                  {{#id}}
                  <div class="sect-bn"><button class="btn btn-warning btn-sm linkOffCanvasNavigation" data-url="/tools1/pages/gadget/add.aspx?DID={{id}}" data-target="ffcMainFormContainer" data-bs-toggle="offcanvas" data-bs-target="#ffcMainForm" id="BtnModification" >Modifier la demande</button></div>
                  {{/id}}
                </br>
                  <div>
...
<!--<script src="/tools/gadget/show.js"></script>-->
<script type="text/javascript">
  appHelper.loadJSWithNameSpace("showGadget", 'showGadget', "controller/gadget/show.js");
</script>