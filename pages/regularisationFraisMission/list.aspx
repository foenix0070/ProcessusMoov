    ...
    <table class="table table-bordered table-responsive table-striped">
      ...
      <tbody>
        ...
        <tr class="" >
          ...
          <td>{{startdate}}</td>
          <td>{{enddate}}</td>
          <td><a href="http://ci08vmmitest/tools1/pages/regularisationFraisMission/show.aspx?id={{id}}"  class="linkMainNavigation" data-url="http://ci08vmmitest/tools1/pages/regularisationFraisMission/show.aspx?id={{id}}" data-target="DivMainPageContainer">{{title}} </a></td>
