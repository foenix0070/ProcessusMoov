          ...
          <%@ Assembly
            ...
            <%@ Register Tagprefix="WebPartPages" Namespace="Microsoft.SharePoint.WebPartPages"
              ...
              <body>
                  ...
                  <div class="App">
                    ...
                    <div class="block2">
                      ...
                      <section class="block2-change2">
                        <section class="sect1">
                          <h2 class="bord-title "><span class="document"> Demande de v&eacute;hicule </span></h2>
                        </section>
                        <section class="sect1">
                          <h3>Historique</h3>
                          ...
                          <form action="" method="" class="form" id="form">
                            <div class="elts">
                                ...
                                <fieldset class="f" style="width: 100%;">
                                    ...
                                    Objet de la demande
                                    <input type="text" name="TxtArticle" placeholder="Objet " id="TxtArticle">
                                  </label>
                ...
                <script  src="/tools/vehicule/app.js" ></script>
                <script type="text/javascript">
                  appHelper.loadJSWithNameSpace("appVehicule", 'appVehicule' ,"app.js");
              </script>
              </body>
