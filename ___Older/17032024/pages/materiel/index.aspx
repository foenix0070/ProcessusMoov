          ...
          <%@ Assembly
            ...
            <%@ Register Tagprefix="WebPartPages" Namespace="Microsoft.SharePoint.WebPartPages"
              ...
              <body>
                  ...
                  <div class="App">
                    ...
                    <div class="block2">
                      ...
                      <section class="block2-change2">
                        <section class="sect1">
                          <h2 class="bord-title "><span class="document"> Demande de mat&eacute;riel </span></h2>
                        </section>
                        <section class="sect1">
                          <h3>Historique</h3>
                ...
                <script  src="/tools/materiel/app.js" ></script>
                <script type="text/javascript">
                  appHelper.loadJSWithNameSpace("appMateriel", 'appMateriel' ,"app.js");
              </script>
              </body>
